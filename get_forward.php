...
/*
$get_field_1 = 'Mech';//mysql_real_escape_string($data->dept);
$get_type = 'type03';//mysql_real_escape_string($data->type);
*/
$get_field_1 = mysql_real_escape_string($data->dept);
...
$result = mysql_query("SELECT * FROM login where field_2='$get_manager' AND field_3='$get_field_1' ");
