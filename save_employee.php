...
else
{
	$result = mysql_query("UPDATE login SET 
				email='$get_email',	name='$get_name',password='$get_password',
				mobile='$get_mobile',field_1='$get_field_1',	field_2='$get_field_2',
				field_3='$get_field_3',field_4='$get_field_4',field_5='$get_field_5',
				field_6='$get_field_6',field_7='$get_field_7',field_8='$get_field_8' 		
